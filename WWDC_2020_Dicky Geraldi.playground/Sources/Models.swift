...
struct Content {
    ...
    init(id: String, title: String, content: String, imageContent: UIImage) {
        self.idData = id
        self.title = title
...
//    if indexed.count == 0 {
//        let content = Content.init(id: "", title: "Still no content here, let's go and scan QR first", content: "", imageContent: #imageLiteral(resourceName: "Photo1"))
//        let contentTable = ContentTable.init(idData: "", title: "Still no content here, let's go and scan QR first", colorMask: #colorLiteral(red: 0.937254902, green: 0.5803921569, blue: 0.9647058824, alpha: 1), imageContent: #imageLiteral(resourceName: "Photo1"))
//        tempContent = [content]
